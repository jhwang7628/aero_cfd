...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Apr 27 22:38:34 2015
# Project:  dobashi.pro
# Template: app
...
SOURCES       = main.cpp \
		src/streamsound.cpp \
		src/ui_window.cpp moc_streamsound.cpp
OBJECTS       = main.o \
		streamsound.o \
		ui_window.o \
		moc_streamsound.o
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/dobashi1.0.0/ && $(COPY_FILE) --parents include/readsound.h include/sourcefunction.h include/streamsound.h include/ui_window.h .tmp/dobashi1.0.0/ && $(COPY_FILE) --parents main.cpp src/streamsound.cpp src/ui_window.cpp .tmp/dobashi1.0.0/ && (cd `dirname .tmp/dobashi1.0.0` && $(TAR) dobashi1.0.0.tar dobashi1.0.0 && $(COMPRESS) dobashi1.0.0.tar) && $(MOVE) `dirname .tmp/dobashi1.0.0`/dobashi1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/dobashi1.0.0
...
compiler_moc_header_make_all: moc_streamsound.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_streamsound.cpp
moc_streamsound.cpp: include/ui_window.h \
		include/sourcefunction.h \
		include/streamsound.h
	/usr/local/Cellar/qt/4.8.6/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ include/streamsound.h -o moc_streamsound.cpp
...
streamsound.o: src/streamsound.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o streamsound.o src/streamsound.cpp

ui_window.o: src/ui_window.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ui_window.o src/ui_window.cpp

moc_streamsound.o: moc_streamsound.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_streamsound.o moc_streamsound.cpp
