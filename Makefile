...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon May 18 13:51:43 2015
# Project:  dobashi.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/dobashi1.0.0/ && $(COPY_FILE) --parents include/readsound.h include/sourcefunction.h include/streamsound.h include/ui_window.h include/LeapMotion.h include/ObjectLoader.h include/auxFunc.h include/FrameExporter.h parameters.h .tmp/dobashi1.0.0/ && $(COPY_FILE) --parents main.cpp src/sourcefunction.cpp src/streamsound.cpp src/ui_window.cpp src/LeapMotion.cpp src/ObjectLoader.cpp src/FrameExporter.cpp .tmp/dobashi1.0.0/ && (cd `dirname .tmp/dobashi1.0.0` && $(TAR) dobashi1.0.0.tar dobashi1.0.0 && $(COMPRESS) dobashi1.0.0.tar) && $(MOVE) `dirname .tmp/dobashi1.0.0`/dobashi1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/dobashi1.0.0
...
ObjectLoader.o: src/ObjectLoader.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ObjectLoader.o src/ObjectLoader.cpp

FrameExporter.o: src/FrameExporter.cpp 
