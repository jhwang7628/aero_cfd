#############################################################################
# Makefile for building: aerosound_mocap.app/Contents/MacOS/aerosound_mocap
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed May 4 15:40:59 2016
# Project:  aerosound_mocap.pro
# Template: app
# Command: /usr/local/bin/qmake -spec /usr/local/Cellar/qt/4.8.6/mkspecs/macx-g++ -o Makefile aerosound_mocap.pro
#############################################################################
...
SOURCES       = main.cpp \
		...
		src/FrameExporter.cpp moc_ui_window.cpp
OBJECTS       = main.o \
		sourcefunction.o \
		streamsound.o \
		ui_window.o \
...
DIST          = /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		...
		aerosound_mocap.pro
QMAKE_TARGET  = aerosound_mocap
DESTDIR       = 
TARGET        = aerosound_mocap.app/Contents/MacOS/aerosound_mocap
...
all: Makefile aerosound_mocap.app/Contents/PkgInfo aerosound_mocap.app/Contents/Resources/empty.lproj aerosound_mocap.app/Contents/Info.plist $(TARGET)

$(TARGET):  $(OBJECTS)  
	@$(CHK_DIR_EXISTS) aerosound_mocap.app/Contents/MacOS/ || $(MKDIR) aerosound_mocap.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: aerosound_mocap.pro  /usr/local/Cellar/qt/4.8.6/mkspecs/macx-g++/qmake.conf /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/local/Cellar/qt/4.8.6/mkspecs/macx-g++ -o Makefile aerosound_mocap.pro
...
aerosound_mocap.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) aerosound_mocap.app/Contents || $(MKDIR) aerosound_mocap.app/Contents 
	@$(DEL_FILE) aerosound_mocap.app/Contents/PkgInfo
	@echo "APPL????" >aerosound_mocap.app/Contents/PkgInfo
aerosound_mocap.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) aerosound_mocap.app/Contents/Resources || $(MKDIR) aerosound_mocap.app/Contents/Resources 
	@touch aerosound_mocap.app/Contents/Resources/empty.lproj
	
aerosound_mocap.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) aerosound_mocap.app/Contents || $(MKDIR) aerosound_mocap.app/Contents 
	@$(DEL_FILE) aerosound_mocap.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,aerosound_mocap,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.6/mkspecs/macx-g++/Info.plist.app >aerosound_mocap.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/aerosound_mocap1.0.0 || $(MKDIR) .tmp/aerosound_mocap1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/aerosound_mocap1.0.0/ && $(COPY_FILE) --parents include/readsound.h include/sourcefunction.h include/streamsound.h include/ui_window.h include/LeapMotion.h include/ObjectLoader.h include/auxFunc.h include/FrameExporter.h parameters.h .tmp/aerosound_mocap1.0.0/ && $(COPY_FILE) --parents main.cpp src/sourcefunction.cpp src/streamsound.cpp src/ui_window.cpp src/LeapMotion.cpp src/ObjectLoader.cpp src/FrameExporter.cpp .tmp/aerosound_mocap1.0.0/ && (cd `dirname .tmp/aerosound_mocap1.0.0` && $(TAR) aerosound_mocap1.0.0.tar aerosound_mocap1.0.0 && $(COMPRESS) aerosound_mocap1.0.0.tar) && $(MOVE) `dirname .tmp/aerosound_mocap1.0.0`/aerosound_mocap1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/aerosound_mocap1.0.0
...
distclean: clean
	-$(DEL_FILE) -r aerosound_mocap.app
	-$(DEL_FILE) Makefile
...
moc_ui_window.cpp: include/LeapMotion.h \
...
LeapMotion.o: src/LeapMotion.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o LeapMotion.o src/LeapMotion.cpp

ObjectLoader.o: src/ObjectLoader.cpp IO/IO.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ObjectLoader.o src/ObjectLoader.cpp

FrameExporter.o: src/FrameExporter.cpp IO/IO.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o FrameExporter.o src/FrameExporter.cpp
