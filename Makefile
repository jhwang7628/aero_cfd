...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon May 4 23:00:19 2015
# Project:  dobashi.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		src/streamsound.cpp \
		src/ui_window.cpp \
		src/LeapMotion.cpp moc_ui_window.cpp
OBJECTS       = main.o \
		sourcefunction.o \
		streamsound.o \
		ui_window.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/dobashi1.0.0/ && $(COPY_FILE) --parents include/readsound.h include/sourcefunction.h include/streamsound.h include/ui_window.h include/LeapMotion.h parameters.h .tmp/dobashi1.0.0/ && $(COPY_FILE) --parents main.cpp src/sourcefunction.cpp src/streamsound.cpp src/ui_window.cpp src/LeapMotion.cpp .tmp/dobashi1.0.0/ && (cd `dirname .tmp/dobashi1.0.0` && $(TAR) dobashi1.0.0.tar dobashi1.0.0 && $(COMPRESS) dobashi1.0.0.tar) && $(MOVE) `dirname .tmp/dobashi1.0.0`/dobashi1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/dobashi1.0.0
